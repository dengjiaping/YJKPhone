...
public final class FRToast {
    ...
    private static Resources getResources() {
        return ExitApplicaton.getInstance().getResources();
    }
    ...
    private static long getMainThreadId() {
        return ExitApplicaton.getmMainThreadId();
    }
    ...
    private static Handler getHandler() {
        return ExitApplicaton.getmMainThreadHandler();
    }
    ...
    private static void showToast(String str) {
        Context context = ExitApplicaton.getInstance();
        if (context != null) {
