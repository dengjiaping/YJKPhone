package com.sinosoft.fhcs.android.view;
...
public class RotateLoadingLayout extends LoadingLayout {
	...
	private void init(Context context) {
		...
		mArrowImageView.setImageResource(R.drawable.custom_default_ptr_rotate);
	...
	protected View createLoadingView(Context context, AttributeSet attrs) {
		View container = LayoutInflater.from(context).inflate(
				R.layout.custom_pull_to_refresh_header2, null);
		return container;
	}
